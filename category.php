            ...
            <ul id="category-tabs">
                <li><a href="category.php?cat=socks_all" class="main-category">Socks</a>
                    <ul class="sub-category-tabs">
                        <li><a href="category.php?cat=socks_all" onclick="updCatsAll()">All socks</a></li>
                        <li><a href="category.php?cat=socks_basic" onclick="updCatsBasic()">Basic</a></li>
                        <li><a href="category.php?cat=socks_pattern">With patterns</a></li>
                        <li><a href="category.php?cat=socks_memes">With memes</a></li>
                    </ul>
                </li>
            </ul>
            <ul id="category-tabs">
                <li><a href="category.php?cat=headwear_all" class="main-category">Head wear</a>
                </li>
            </ul>
            <ul id="category-tabs">
                <li><a href="category.php?cat=card_all">Gift cards</a></li>
            </ul>
        </div>
